...
//        public static String local = "https://pbt.raadarbar.com/api/";/**/
    ...
    public static String ESTIMATED = "Estimated Price";
    public static String KALUPUR = "kalupur";
    public static String RUPEE = " ₹ ";
    public static String RUPEE_1 = "₹  ";
    public static String DASH = " - ";
    public static String PRICE = "197";
    public static String AIRPORT = "airport";
    public static String PARKING_CHARGE = " (Parking Charge ₹ 90) ";
    public static String YOUR_WALLET = "Your Wallet Amount : ";
