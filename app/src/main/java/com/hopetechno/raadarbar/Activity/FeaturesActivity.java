...
public class FeaturesActivity extends AppCompatActivity implements AppConstant {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(FeaturesActivity.this, CustHomePageActivity.class));
        finish();
    }
    ...
    void getFeatures() {
        ...
        progstart(FeaturesActivity.this, "Loading...", "Loading...");

        Log.e("role", role);

        StringRequest postRequest = new StringRequest(Request.Method.GET, features,
...
//                            webView.loadData(velue, "text/html", "UTF-8");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progstop();
                        Toast.makeText(FeaturesActivity.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        ) {
            @Override
