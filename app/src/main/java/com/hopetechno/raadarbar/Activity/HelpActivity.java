...
public class HelpActivity extends AppCompatActivity implements AppConstant {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(HelpActivity.this, CustHomePageActivity.class));
        finish();
    }
    ...
    void gethelp() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, help + "customer",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONObject customer_data = submain.getJSONObject("customer_data");
