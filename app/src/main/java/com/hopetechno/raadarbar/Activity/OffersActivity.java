...
public class OffersActivity extends AppCompatActivity implements AppConstant {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(OffersActivity.this, CustHomePageActivity.class));
        finish();
    }
    ...
    void getoffers() {
        ...
        progstart(OffersActivity.this, "Loading...", "Loading...");
